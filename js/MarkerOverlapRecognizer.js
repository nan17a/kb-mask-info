...
var MarkerOverlappingRecognizer = function(opts) {
    this._options = $.extend({
        ...
        intersectNoticeTemplate: '<div style="font-size:11px;border:solid 1px #333;background-color:#fff;padding:5px;width:180px;"><em style="font-weight:bold;color:#f00;">{{count}}</em>개의 마커가 있습니다.</div>',
        intersectList: true,
        intersectListTemplate: '<div style="border:solid 1px #333;background-color:#fff;">'
                  ...
                  + '    <div class="list-items-body-content">'
...
MarkerOverlappingRecognizer.prototype = {
    ...
    setClearCurInfo: function(fnc) {
        this._clearCurInfo=fnc;
    },
